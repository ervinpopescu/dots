...
def render_markdown(doc_id, md_text, clear=True):
    ...
    for seg_idx, (seg_type, seg_data) in enumerate(segments):
        ...
        if seg_type == "text":
            ...
            # 1. Insert Text
            execute_batch(
                doc_id, [{"insertText": {"location": {"index": insert_pos}, "text": full_text}}]
            )
                    ...
                    style_reqs.append(
                        {
                            "updateTextStyle": {
                                ...
                                "textStyle": {
                                    ...
                                    "foregroundColor": {
                                        "color": {
                                            "rgbColor": {"red": 0.08, "green": 0.2, "blue": 0.45}
                                        }
                                    },
                                },
                ...
                style_reqs.append(
                    {
                        "updateTableCellStyle": {
                            ...
                            "tableCellStyle": {
                                "backgroundColor": {
                                    "color": {
                                        "rgbColor": {"red": 0.92, "green": 0.95, "blue": 0.99}
                                    }
                                }
                            },
                        ...
                        style_reqs.append(
                            {
                                "updateTextStyle": {
                                    "range": {"startIndex": cell_start, "endIndex": cell_end},
                                    "textStyle": {"fontSize": {"magnitude": 9.0, "unit": "PT"}},
                                    "fields": "fontSize",
                                }
                            }
                        )
